function [r_minus,success] = radii_polynomial_variational_equation_backward(C,ta,theta,h,N,n,n_pad_cheb,nu,core)
...
DF = DF_Fourier_Chebyshev_backward(ta,theta,h,N,n,core);% interval
...
%     b = weight(j)*B(j,:);
    ...
    F_ext = F_Fourier_Chebyshev_backward_ext(c,ta,b,theta,h,N,n,core);% interval
