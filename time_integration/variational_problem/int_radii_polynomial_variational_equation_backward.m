function [r_minus,success] = int_radii_polynomial_variational_equation_backward(C,ta,theta,h,N,n,m,n_pad_cheb,nu)
...
ih = intval(h);
iDF = int_DF_Fourier_Chebyshev_backward(ita,theta,ih,N,n,m);
DF = mid(iDF);
...
for j = 1:2*m+1
    ...
    F_ext = int_F_Fourier_Chebyshev_backward_ext(c,ita,b,theta,h,N,n,m);
